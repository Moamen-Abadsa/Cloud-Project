...
class All_courses_for_lecturer : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_all_courses_for_lecturer)
        ...
        search_btn2.setOnClickListener {
            var input = search_courses_lec.text.toString()

            var intent_search = Intent(this,Search::class.java)
            intent_search.putExtra("Type","Course_lecturer")
